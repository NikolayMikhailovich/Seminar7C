...
{
  int[,] array = new int[l, c]; Random rnd = new Random();
...
void PrintArray(int[,] array)
{
  ...
  for (int i = 0; i < array.GetLength(0); i++)
  {
    Console.WriteLine(); for (int j = 0; j < array.GetLength(1); j++)
    {
...
if (check)
{
  Console.WriteLine($"Введенный элемент {number}, результат: {x + 1}, {y + 1}");
}
else
{
